...
describe Address2 do
  describe "with new" do
    let(:address) { Address2.new(street: "12 Smith Street", city_name: "Burpengary") }
    it { address.postcode.must_equal "4505" }
    it { address.valid?.must_equal true }
  end

  describe "with create" do
    let(:address) { Address2.new(street: "12 Smith Street", city2: city2(:burp)) }
    it { address.postcode.must_equal "4505" }
  ...
  describe "with new" do
    let(:address) { Address2.new(street: "12 Smith Street", city_name: "Beverly Hills") }
